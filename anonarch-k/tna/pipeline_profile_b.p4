...
control SwitchIngress_b(
    ...
    action set_anonarch_ip_b() {
        hdr.anonarch.ip_magnitude = ig_md.stats_ip.magnitude;
        hdr.anonarch.ip_radius = ig_md.stats_ip.radius;
    }

    action set_anonarch_ip_b_64() {
        hdr.anonarch.ip_sum_res_prod_cov = ig_md.stats_ip.cov;
        hdr.anonarch.ip_pcc = ig_md.stats_ip.pcc;
    }

    action set_anonarch_five_t_b() {
        hdr.anonarch.five_t_magnitude = ig_md.stats_five_t.magnitude;
        hdr.anonarch.five_t_radius = ig_md.stats_five_t.radius;
    }

    action set_anonarch_five_t_b_64() {
        hdr.anonarch.five_t_sum_res_prod_cov = ig_md.stats_five_t.cov;
        hdr.anonarch.five_t_pcc = ig_md.stats_five_t.pcc;
    }
    ...
    apply {
        ...
        set_anonarch_ip_b();
        set_anonarch_ip_b_64();
        set_anonarch_five_t_b();
        set_anonarch_five_t_b_64();
    }
}
