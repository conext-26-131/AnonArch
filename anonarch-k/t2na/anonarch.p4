...
control SwitchIngress(
    ...
    */
    ...
    action set_custom_hdrs() {
        ...
        hdr.anonarch.decay = hdr.meta.decay_cntr;
        hdr.anonarch.mac_ip_src_hash = ig_md.stats_mac_ip_src.hash_0;
        hdr.anonarch.ip_hash = ig_md.stats_ip.hash_0;
    }

	table fwd {
		key = {
			ig_intr_md.ingress_port : exact;
            // hdr.anonarch.ml_exec : exact;
		}
		actions = {
            set_out_port;
            miss;
...
control SwitchEgress(
    ...
    action trunc_pkt() {
        // Truncate packet (ethernet + ipv4 + anonarch).
        // eg_dprsr_md.mtu_trunc_len = 146;
        hdr.anonarch.ip_src_hash = eg_md.stats_ip_src.hash_0;
        hdr.anonarch.five_t_hash = eg_md.stats_five_t.hash_0;
        hdr.anonarch.setValid();
    }
