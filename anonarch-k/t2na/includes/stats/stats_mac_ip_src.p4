...
control c_stats_mac_ip_src(inout header_t hdr, inout ingress_metadata_t ig_md) {
    ...
    RegisterAction<_, bit<1>, bit<32>>(reg_mac_ip_src_mean_sqr) ract_mean_sqr_calc = {
        void apply(inout bit<32> val, out bit<32> res) {
            val = mean_sqr.execute(hdr.anonarch.mac_ip_src_mean);
            res = val;
        }
    };
    */
    ...
    */
    ...
    action pkt_cnt_incr() {
        hdr.anonarch.mac_ip_src_pkt_cnt = ract_pkt_cnt_incr.execute(ig_md.stats_mac_ip_src.hash_0);
    }
    ...
    */
    ...
    apply {
        ...
        mean_sqr.apply(hdr.anonarch.mac_ip_src_mean, ig_md.stats_mac_ip_src.mean_sqr);
        ...
        std_dev.apply(ig_md.stats_mac_ip_src.variance, hdr.anonarch.mac_ip_src_std_dev);
    }
}
